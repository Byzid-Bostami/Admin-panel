...
const Page = () => {
  ...
  const pageTitle: string = "health Posts";
  ...
  // Filter only posts with status "public" and sort by createdAt in descending order
  const recentPosts: Post[] = [...allPosts]
    .filter((post) => post.category === "health")
    .sort(
      (a, b) =>
        ...
        {Ploading ? (
          ...
          recentPosts.map((post: Post) => (
            <div
              ...
              key={post._id}
            >
              <div className="bg-stone-100 cursor-pointer shadow shadow-black/40 md:hover:scale-105 transition-all duration-150 hover:shadow-black rounded-md p-5 space-y-5">
